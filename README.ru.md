...
[![GitHub](https://img.shields.io/badge/github-ReGameDLL_CS-blue?logo=github)](https://github.com/rehlds/ReGameDLL_CS)
[![GitHub](https://img.shields.io/badge/github-ReAPI-blue?logo=github)](https://github.com/rehlds/reapi)
[![GitHub](https://img.shields.io/badge/github-Metamod_R-blue?logo=github)](https://github.com/rehlds/Metamod-R)
[![Game](https://img.shields.io/badge/Game-CS%201.6%20%7C%20CZero-blue)](https://www.counter-strike.net)

> **Zombie Plague** — это серверная модификация для Counter-Strike, реализованная как плагин для AMX Mod X.  
> Она полностью меняет геймплей, превращая игру в напряжённое противостояние «Люди против Зомби».

---

## 🎮 Описание

Хотя мод основан на классических зомби-инфекциях, он выводит концепцию на новый уровень благодаря следующим возможностям:

### ✨ Особенности

- **Новые режимы игры**: Немезида, Выживший, Множественная инфекция, Рой и другие.
- **Система классов зомби** — добавляйте неограниченное количество классов.
- **Система классов людей** — добавляйте неограниченное количество классов.
- **Ammo Packs** — валюта для умелых игроков, которую можно обменять на снаряжение.
- **Система дополнительных предметов** — безлимитное добавление кастомных предметов.
- **Кастомные гранаты**: зажигательные, морозные, вспышки, инфекционные бомбы.
- **Deathmatch-режим** — зомби или люди постоянно возрождаются.
- **Админ-меню** — удобное управление консольными командами.
- **Эффекты движка HL**: динамическое освещение, туман и другое.

### ⚙️ Кастомизация

Вы можете гибко настраивать мод под свой стиль игры:

- Здоровье, скорость, модели, награды для зомби и людей.
- Бесконечные боезапасы и регулируемая отдача (knockback).
- Включение/отключение и настройка режимов игры.
- Общее освещение карты (доступны эффекты молний для тёмных настроек).
- Цвет и размер фонарика и ночного видения.
- Leap (прыжки) и отсутствие замедления при получении урона.
- Эффекты заражения: искры, тряска экрана и другое.
- Рандомное возрождение (совместимость с CSDM-spawn).
- Замена звуков и фоновой музыки.
...
|-----------|-------------|
| **Сервер** | Counter-Strike 1.6 **или** Condition-Zero |
| **ReAmxModX** | Версия **1.8.3 build 7** или новее |
| **ReHLDS** | Версия **3.14.0.857** или новее |
| **ReGameDLL_CS** | Версия **5.28.0.756** или новее |
| **ReAPI** | Версия **5.26.0.338** или новее |
| **Metamod-R** | Версия **1.3.0.149** или новее |

---

## 🛠️ Установка

1. Скачайте и распакуйте содержимое `.zip` архивов в папку сервера (`cstrike` или `czero`), **сохраняя структуру папок**:

   - `zp_plugin_50.zip` — сам плагин и конфигурационные файлы.
   - `zp_resources.zip` — стандартные модели и звуки (требуется только для первой установки).

2. Подробнее о CVARs и командах читайте в файле `ReadMe.txt`, который идёт в комплекте.

---

## 🔗 См. также

- [ZP 5.0 Betas / Updates](https://forums.alliedmods.net/showthread.php?t=72505) — архив официальной версии мода
...
<details>
<summary><b>📜 Older versions (4.3-beta5 → 3.55)</b></summary>
...
⭐ **Если вам нравится этот мод, поставьте звёздочку на GitHub!**  
🐛 **Сообщать об ошибках и предлагать улучшения можно через [Issues](#).**
