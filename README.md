...
- **Zombie Classes System** — allows adding unlimited custom zombie classes
- **Human Classes System** — allows adding unlimited custom human classes
...
You can flexibly adjust the mod to fit your gameplay style:
...
- Change overall map lighting (lightnings available for dark settings)
...
| **ReAmxModX** | Version **1.8.3 build 7** or later |
| **ReHLDS** | Version **3.14.0.857** or later |
| **ReGameDLL_CS** | Version **5.28.0.756** or later |
| **ReAPI** | Version **5.26.0.338** or later |
| **Metamod-R** | Version **1.3.0.149** or later |
...
- [ZP 5.0 Betas / Updates](https://forums.alliedmods.net/showthread.php?t=72505) — archive of the official version of the mod
...
⭐ **If you like this mod, star it on GitHub!**  
